...
#SF_CHECK_PATH_RESULTS
SF_CHRCK_RESULTS = '/rootfs/autolearn/check_result.csv'
SF_CHRCK_RESULTS_TRANSFORM = '/rootfs/autolearn/transform_check_result.csv'
